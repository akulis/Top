...
function minicart() {
  ...
  function template() {
    return [
      ...
      '.minicart .minicart-detail .fa-caret-up {position: absolute;top: -18px;right: 10px;color: #ffffff;}',
      ...
      '.minicart .minicart-detail .more a {float:right;font-size:85%; color:#ffffff;}',
      '</style>',
