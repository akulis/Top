...
function minicart() {
  ...
  function template() {
    return [
      '<style>',
      '.minicart { padding: 15px 20px 5px 0; float: right; cursor: pointer;color: #25337a; min-width:285px; text-align:right;}',
      '@media (max-width: 768px) {.minicart { min-width:auto; } }',
      '.text-muted {color: #25337a;}',
      '.text-mutedCaretDown {color: #25337a;}',
      ...
      '.minicart .minicart-detail .fa-caret-up {position: absolute;top: -18px;right: 10px;color: #25337a;}',
      ...
      '.minicart .minicart-detail .more a {float:right;font-size:85%; color:#25337a;}',
      '</style>',
      ...
      '            <i cla25337ass="fa fa-caret-up fa-2x"></i>',
      '            <ul>',
