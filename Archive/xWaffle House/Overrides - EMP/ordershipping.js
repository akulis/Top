four51.app.directive('ordershipping', ['Order', 'Shipper', 'Address', 'AddressList', function(Order, Shipper, Address, AddressList) {
	var obj = {
		...
		controller: ['$scope', function($scope) {
			...
			//This was added for changing shippers
			$scope.shipFilter = function(shipper){
		    if shipper.Name == 'USPS Priority Mail 2-Day™' || shipper.Name == 'UPS Ground' {
					return shipper.Name == 'USPS Priority Mail 2-Day™' || shipper.Name == 'UPS Ground';
				}
				else if shipper.Name == 'USPS Priority Mail 2-Day™' || shipper.Name == 'USPS USPS Retail Ground™' || shipper.Name == 'UPS Ground' {
					return shipper.Name == 'USPS USPS Retail Ground™' || shipper.Name == 'UPS Ground';
				};
			}]
		};
	return obj;
