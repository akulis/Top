...
function minicart() {
  ...
  function template() {
    return [
      '<style>',
      '.minicart { padding: 15px 20px 5px 0; float: right; cursor: pointer;color: #47292b; min-width:285px; text-align:right;}',
      '@media (max-width: 768px) {.minicart { min-width:auto; } }',
      '.text-muted {color: #47292b;}',
      '.text-mutedCaretDown {color: #47292b;}',
      ...
      '.minicart .minicart-detail .fa-caret-up {position: absolute;top: -18px;right: 10px;color: #47292b;}',
      ...
      '.minicart .minicart-detail .more a {float:right;font-size:85%; color:#47292b;}',
      '</style>',
