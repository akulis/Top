...
function minicart() {
  ...
  function template() {
    return [
      '<style>',
      '.minicart { padding: 15px 20px 5px 0; float: right; cursor: pointer;color: #333132; min-width:285px; text-align:right;}',
      '@media (max-width: 768px) {.minicart { min-width:auto; } }',
      '.text-muted {color: #333132;}',
      '.text-mutedCaretDown {color: #333132;}',
      ...
      '.minicart .minicart-detail .fa-caret-up {position: absolute;top: -18px;right: 10px;color: #333132;}',
      ...
      '.minicart .minicart-detail .more a {float:right;font-size:85%; color:#333132;}',
      '</style>',
