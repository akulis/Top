...
function minicart() {
  ...
  function template() {
    return [
      '<style>',
      '.minicart { padding: 15px 20px 5px 0; float: right; cursor: pointer;color: #Replace-This-Color; min-width:285px; text-align:right;}',
      '@media (max-width: 768px) {.minicart { min-width:auto; } }',
      '.text-muted {color: #Replace-This-Color;}',
      '.text-mutedCaretDown {color: #Replace-This-Color;}',
      ...
      '.label {color: #Replace-This-Color}',
      ...
      '.minicart .minicart-detail .fa-caret-up {position: absolute;top: -18px;right: 10px;color: #Replace-This-Color;}',
      ...
      '.minicart .minicart-detail .more a {float:right;font-size:85%; color:#Replace-This-Color;}',
      '</style>',
